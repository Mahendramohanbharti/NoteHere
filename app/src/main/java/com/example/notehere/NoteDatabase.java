...
public class NoteDatabase extends SQLiteOpenHelper {
    ...
    //coloumn name for database table
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // CREATE TABLE name(id INT PRIMARY KEY,title TEXT,content TEXT, date DATE, time TIME);
    ...
    public Note getNote(long id){
        ...
        Cursor cursor=db.query(DATABASE_TABLE,new String[]{KEY_ID,KEY_TITLE,KEY_CONTENT,KEY_DATE,KEY_TIME},KEY_ID+"=?",new String[]{String.valueOf(id)}
                ,null,null,null);
        if(cursor!=null)
            cursor.moveToFirst();
